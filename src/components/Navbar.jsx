...
const Navbar = () => {
  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto flex justify-between py-5 sticky top-0  bg-white">
      ...
      <button onClick={displayMenu} className="lg:hidden">
        <svg
          width="32px"
          height="32px"
          viewBox="0 0 24 24"
      ...
      <div
        className={`lg:hidden ${
          view ? "opacity-100" : "h-0 opacity-0"
        } z-50 transition-all duration-300 flex flex-col absolute top-20 bg-white w-full justify-between gap-5 `}
      >
        <a href="" className="text-xl">
          Home
        </a>
